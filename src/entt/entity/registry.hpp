...
class Registry {
	...
	using component_family = Family<Seed, Entity, struct InternalRegistryComponentFamily>;
	using view_family = Family<Seed, Entity, struct InternalRegistryViewFamily>;
...
public:
     ...
     *
     * @see View
     * @see View<Entity, Seed, Component>
     * @see PersistentView
     *
     ...
     */
    template<typename... Component>
    View<Entity, Seed, Component...> view() {
        return View<Entity, Seed, Component...>{ensure<Component>()...};
    }
     ...
     */
    template<typename... Component>
    PersistentView<Entity, Seed, Component...> persistent() {
        // after the calls to handler, pools have already been created
        return PersistentView<Entity, Seed, Component...>{handler<Component...>(), pool<Component>()...};
    }
